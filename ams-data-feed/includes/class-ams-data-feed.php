...
class Ams_Data_Feed {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Ams_Data_Feed_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Ams_Data_Feed_Loader. Orchestrates the hooks of the plugin.
	 * - Ams_Data_Feed_i18n. Defines internationalization functionality.
	 * - Ams_Data_Feed_Admin. Defines all hooks for the admin area.
	 * - Ams_Data_Feed_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Ams_Data_Feed_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
